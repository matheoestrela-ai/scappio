  ...
  return (
    <div className="relative min-h-screen bg-hero pb-24 md:pb-0">
      ...
      <section className="container pt-8 md:pt-16 pb-16 md:pb-24 text-center">
        ...
        <h1 className="mx-auto mt-6 max-w-4xl text-[2rem] leading-[1.4] font-bold tracking-tight sm:text-5xl md:text-7xl md:leading-[1.3]">
          Transforme tes{" "}
          <span
            className="inline-block align-middle font-normal italic text-[hsl(265_85%_70%)] leading-none -rotate-2 text-[1.25em] mx-1 translate-y-[-0.02em]"
